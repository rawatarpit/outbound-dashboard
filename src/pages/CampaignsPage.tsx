  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        <Card className="rounded-2xl border-border/50 bg-card/50 backdrop-blur-sm">
          <CardContent className="p-5 flex items-center gap-4">
            <div className="h-10 w-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#3b82f612' }}>
              <Send className="h-5 w-5" style={{ color: '#3b82f6' }} />
            </div>
            <div>
              <p className="text-2xl font-bold text-foreground tracking-tight"><AnimatedCounter value={totalSent} /></p>
        ...
        <Card className="rounded-2xl border-border/50 bg-card/50 backdrop-blur-sm">
          <CardContent className="p-5 flex items-center gap-4">
            <div className={`h-10 w-10 rounded-xl flex items-center justify-center`} style={{ backgroundColor: bounceRate > 0.05 ? '#ef444412' : '#a3a3a312' }}>
              <AlertTriangle className="h-5 w-5" style={{ color: bounceRate > 0.05 ? '#ef4444' : '#a3a3a3' }} />
            </div>
            <div>
              <p className={`text-2xl font-bold tracking-tight ${bounceRate > 0.05 ? 'text-red-500' : 'text-foreground'}`}>
                <AnimatedCounter value={bounceRate * 100} decimals={1} suffix="%" />
              </p>
        ...
        <Card className="rounded-2xl border-border/50 bg-card/50 backdrop-blur-sm">
          <CardContent className="p-5 flex items-center gap-4">
            <div className="h-10 w-10 rounded-xl flex items-center justify-center" style={{ backgroundColor: replyRate > 0.03 ? '#10b98112' : '#a3a3a312' }}>
              <Reply className="h-5 w-5" style={{ color: replyRate > 0.03 ? '#10b981' : '#a3a3a3' }} />
            </div>
            <div>
              <p className={`text-2xl font-bold tracking-tight ${replyRate > 0.03 ? 'text-emerald-500' : 'text-foreground'}`}>
                <AnimatedCounter value={replyRate * 100} decimals={1} suffix="%" />
              </p>
        ...
        <Card className="rounded-2xl border-border/50 bg-card/50 backdrop-blur-sm">
          <CardContent className="p-5 flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-bold text-foreground tracking-tight"><AnimatedCounter value={todaySent} /></p>
